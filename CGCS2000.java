...
//    KrasovskyGPS,6378245.0,6356863.0
...
//    ee = (a^2 - b^2) / a^2;
    ...
    public static double getEE(double a,double b) {
...
//    CGCS2000,6378137.0,6356752.3
    ...
    static double b = 6356752.3;
    static double pi = 3.14159265358979324;

//    static double eeGPS = 0.00669342162296594323;
//   eeCGCS2000 0.006693427489819221
static double ee =getEE(a, b);

    public static void main(String[] args) {
        CGCS2000 navi = new CGCS2000();
        System.out.println(navi.getEE(a, b));
        System.out.println(navi.gcj2cgcs2000(108.06366, 22.57129));

    }


    public String gcj2cgcs2000(double lon, double lat) {
